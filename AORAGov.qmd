...
TreatTableNew <- bind_cols(
  ...
  RegistryCohortName2 = case_when(
    stringr::str_detect(RegistryCohortName,"Knee") & stringr::str_detect(SurgicalTreatment,"Non") ~ "KneeArthritisNS",
    stringr::str_detect(RegistryCohortName,"Hip") & stringr::str_detect(SurgicalTreatment,"Non") ~ "HipArthritisNS",
